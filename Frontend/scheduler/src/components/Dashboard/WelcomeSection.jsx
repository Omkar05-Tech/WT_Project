    ...
    useEffect(() => {
        async function fetchWelcomeData() {
            ...
            try {
                ...
                const response = await fetch("http://localhost:5173/api/WelcomeSection", {
                    headers: {
    ...
    return (
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 text-white shadow-md rounded-lg p-6 mb-8">
            <div className="flex justify-between items-center">
                ...
                <button className="bg-white text-blue-600 py-2 px-6 rounded-lg hover:bg-blue-50 flex items-center">
